...
export const CourseCard: React.FC<CourseCardProps> = ({ item, onClick }) => {
  return (
    <div 
    ...
    >
      <div className="relative h-48 overflow-hidden bg-slate-800">
        ...
        <div className="absolute bottom-2 left-2 bg-slate-950/80 backdrop-blur-sm border border-slate-700 px-2 py-1 rounded text-xs font-bold text-slate-300">
          {item.type}
        </div>
      </div>
      ...
      <div className="p-5 flex-grow flex flex-col">
        ...
        <div className="mt-auto pt-4 border-t border-slate-800 flex items-center justify-between">
          ...
          >
            Review & Info <i className="fas fa-arrow-right ml-1 text-xs"></i>
          </span>
        </div>
      </div>
    </div>
